      ...
      <main id="top">
        <section className="hero">
          <div>
            ...
            <p>
              Football Tips v1.6 starts with football strength. Strong selections stay visible
        ...
        <section id="picks" className="section">
          <div className="section-heading">
            ...
            <span className="pill">v1.6 · 1X STRENGTH GATE</span>
          </div>
        ...
        <section id="method" className="section model-section">
          ...
          <div className="model-grid">
            ...
            <div><strong>02</strong><h3>Strength & H2H Gate</h3><p>Recent form, home/away profile, goals/xG, Poisson/Dixon-Coles, H2H, opponent strength and at least two independent models must be explicitly checked. Major disagreement blocks Core.</p></div>
            <div><strong>03</strong><h3>Away-Favourite Protection</h3><p>A 1X candidate is rejected if the away team's no-vig win probability reaches 60% or more. Only then can edge and EV be considered.</p></div>
